...
public enum TokenType implements Serializable {
   ...
   * This type is associated with the token that is either a byte size value with units like KB, MB, GB, etc.
   */
  BYTE_SIZE, 
  /**
   * Represents the enumerated type for the object of type {@code TimeDuration} type.
   * This type is associated with the token that is either a time duration value with units like ms, s, min, hour,
   * etc.
   */
  TIME_DURATION
}
